...
<div property="content:encoded" class="field-item even">
    ...
    <h2 class="rtecenter">ТДС УкрСпецтехника предлагает свои услуги</h2>
    <p class="rtejustify">
    ...
    <p><img alt="ТДС УкрСпецтехника"
     src="/sites/default/files/images/watermarked,P20-,P20TO_1.jpg.pagespeed.ce.ptl0G5cDcD.jpg" 
     style="height: 467px; width: 700px;">
    </p>
    <p class="rtecenter">&nbsp;</p>
    <p>
        <a name="video">
